...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const totalAmount = 10000; // Total goal in dollars
  const amountRaised = 6000; // Amount already raised
  const amountRemaining = totalAmount - amountRaised;
  ...
  const donationChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              ...
              data: [amountRaised, amountRemaining],
              backgroundColor: ['#4CAF50', '#FF5733'],
              hoverBackgroundColor: ['#45a049', '#FF6F61'],
              borderWidht: 1
          }]
      },
      options: {
...
window.onload = calcScrollValue;
 ...
 //CAUSES IMAGE SLIDER
 var causeImgSlider = new Swiper(".causes_img_slider", {
    loop: true,
    autoplay: true,
    slidesPerView: 1,
    spaceBetween: 20,
    ...
    navigation: {
        nextEl: ".swiper-button-next_cis",
        prevEl: ".swiper-button-prev_cis",
    },
});
