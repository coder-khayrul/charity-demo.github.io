...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var ctx = document.getElementById('impactCounter').getContext('2d');
    var impactChart = new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ['Hours Volunteered', 'Events Organized'],
        datasets: [{
          label: 'Impact',
          data: [300, 100], // Example data: 500 hours, 30 events
          backgroundColor: [
            '#FFAC00',  // Secondary color for hours (yellow)
            '#F74F22'   // Accent color for events (orange)
          ],
          borderWidth: 1
        }]
      },
    ...
    //featered volunteer script 
    //MAIN MENU "BLOG" MEGA MENU SLIDER
    var featredVolunteerSlider = new Swiper(".f_vlunteer_slider", {
        loop: true,
        autoplay: true,
        effect: "flip",
        slidesPerView: 1,
        spaceBetween: 20,
        navigation: {
            nextEl: ".swiper-button-next_fv",
            prevEl: ".swiper-button-prev_fv",
        },
    });
